...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <aside
        className={`
          fixed lg:static inset-y-0 left-0 z-50 w-64 bg-slate-800 text-white p-6 flex flex-col
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="pt-4 border-t border-slate-600">
            ...
            <button
              ...
              className="w-full text-left px-3 py-2 rounded-lg hover:bg-red-700 transition text-sm cursor-pointer"
            >
              Keluar
            </button>
          </div>
